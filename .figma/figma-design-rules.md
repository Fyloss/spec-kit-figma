...
<!--
  ...
  customizations in the sibling overlay `.figma/figma-design-rules.local.md`, which
...
- This file is the **extension-owned base**. A sibling **user overlay**,
  `.figma/figma-design-rules.local.md`, is loaded immediately after it and MAY
...
- The **responsive policy** — which breakpoints are mandatory, whether missing ones
  ...
  the policy declared in the overlay (`.figma/figma-design-rules.local.md`) or the
